/*
  ...
  Description:
     ...
     That is no trivial task. Read the comments and this post, please: 
...
void setup() {
  ...
  */
  ...
  /*
    ...
    3<<COM0B0: sets bits COM0B0, COM0B1 and COM0B2, which (in Fast PWM mode) clears OC0B on compare-match, and clear OC0B at BOTTOM (inverting mode)
