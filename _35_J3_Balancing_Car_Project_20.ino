...
//Various settings
float pid_p_gain = 16;                                       //Gain setting for the P-controller (15)
float pid_i_gain = 0.01;                                      //Gain setting for the I-controller (1.5)
float pid_d_gain = 4.4;                                       //Gain setting for the D-controller (30)
