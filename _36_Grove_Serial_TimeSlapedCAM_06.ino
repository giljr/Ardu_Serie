/*
  FIXME: organize code better!!!

  This is the first draw for my Camera Time Lapse Project - Don't leave me CAM
  Please, help us to get it better!!!
  Demo Film: clouds_youtube_64x.mp4
...
#define CAM_ADDR       0
#define CAM_SERIAL     SoftwareSerial Serial1(21, 20);
...
const int buttonPin = A6;                 // =D4/ the number of the pushbutton pin
...
//MISO = Pin 12
//SCLK = PIN 13
//Set for Arduino Generic Pro Micro 5v
//MOSI = Pin 16
//MISO = Pin 14
//SCLK = PIN 15
